...
#------------------------------------------------------------------------------
# Project 'FB_ZVS_PS_09_07_com_perdas' make using the 'GFortran 4.2.1' compiler.
#------------------------------------------------------------------------------
...
user_source_1.$(CC_Suffix): C:\Users\Leonan\GOOGLE~1\UFRJ\PROJET~1\SIMULA~1\PSCad\\source\CONTRO~4.C
	@echo !--Compile: "C:\Users\Leonan\Google Drive\UFRJ\Projeto Final\simulacoes\PSCad\\source\controle_FB-ZVS-PS_erros_adc.c"
	copy "C:\Users\Leonan\Google Drive\UFRJ\Projeto Final\simulacoes\PSCad\\source\controle_FB-ZVS-PS_erros_adc.c" .
	$(CC_Compile) "controle_FB-ZVS-PS_erros_adc.c"
	del "controle_FB-ZVS-PS_erros_adc.c"
...
CC_ObjectsLong = \
  "controle_FB-ZVS-PS_erros_adc.$(CC_Suffix)" \
...
Binary   = FB_ZVS_PS_09_07_com_perdas.exe
